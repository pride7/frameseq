...
Names, automatic layout, and connectors are covered in [Diagrams](diagrams.md), which shows how to build a diagram whose objects carry no coordinates at all.
